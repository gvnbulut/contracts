...
This privacy policy applies to the Crypto Discover app (hereby referred to as "Application") for mobile devices that was created by GVN Apps (hereby referred to as "Service Provider") as an Ad Supported service. 
